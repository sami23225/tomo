const CACHE='tomo-v43';
const ASSETS=['./','./index.html','./manifest.json','./icon-180.png','./icon-192.png','./icon-512.png','./tomo-theme.css','./tomo-enhance.js','./tomo-sync.js','./tomo-daily.js','./tomo-units.js','./tomo-usage.js'];
